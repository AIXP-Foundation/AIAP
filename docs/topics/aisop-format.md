...
```json
{
  ...
  "content": {
    ...
    "system_prompt": "Role description. Domain guidelines. Mirror User's exact language and script variant. Align: Human Sovereignty and Benefit.",
...
| `system_prompt` | string | Yes      | Core behavioral instruction. Defines role, domain guidelines, language mirroring. MUST end with `"Align: Human Sovereignty and Benefit."` |
